...
\begin{enumerate}
  ...
  o programa deve imprimir a soma entre todos os números ímpares no intervalo $[n,\, m]$.
  \item Faça um programa que calcule a média da altura dos alunos de uma turma.
